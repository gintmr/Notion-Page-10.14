...
module.exports = {
  ...
  FONT_URL: [
    ...
    'https://fonts.googleapis.com/css?family=Cormorant+Garamond:300,400,500,600,700&display=swap',
  ...
  // 衬线字体 例如'"LXGW WenKai"'
  FONT_SERIF: [
    '"Cormorant Garamond"',      // 更优雅的英文字体，300权重更细
    '"Noto Serif SC"',           // 思源宋体，300权重更细
    'Georgia',                   // 优雅的Georgia字体
    'SimSun',
    '"Times New Roman"',
    'Times',
    'serif',
